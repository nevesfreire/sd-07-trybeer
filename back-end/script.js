const db = {
dropDb: 'DROP DATABASE IF EXISTS Trybeer;',
createDb: 'CREATE DATABASE Trybeer;',
useDb: 'USE Trybeer;',
...
createSaleProducts: `CREATE TABLE IF NOT EXISTS sales_products (
...
insertProducts: `INSERT INTO products (id, name, price, url_image) VALUES
